...
CLINICAL_CASES = [
    {
        "id": 1,
        "titulo": "Diagnóstico diferencial de dor torácica",
        ...
        "exames_disponiveis": [
            ...
            {
                "id": "marcadores",
                "nome": "Marcadores de necrose miocárdica",
                "resultado": "Sem alterações.",
                "correto": True,
            },
            {
                "id": "pcr",
                "nome": "PCR",
                "resultado": "25 mg/L (VR: <5 mg/L).",
                "correto": True,
            },
            {
                "id": "tc_torax",
                "nome": "TC de tórax",
                "resultado": "Imagem densa em mediastino médio.",
                "correto": True,
            },
        ],
    },
    {
        "id": 2,
        "titulo": "Cefaleia e Hipertensão Mascarada",
        "especialidade": "Cardiologia",
        "nivel_dificuldade": "Intermediário",
        ...
        "exames_disponiveis": [
            {
                "id": "mapa",
                "nome": "MAPA (24 horas)",
                "resultado": "Média de 154/88 mmHg.",
                "correto": True,
            },
            {
                "id": "ecg",
            ...
            },
            {
                "id": "eco",
                "nome": "Ecocardiograma",
                "resultado": "Hipertrofia ventricular esquerda concêntrica.",
                "correto": True,
            },
            {
                "id": "lab_renal",
                "nome": "Função Renal e Glicemia",
                "resultado": "Ureia=59; Creatinina=1,54; Glicose=112.",
                "correto": True,
            },
        ],
    },
    {
        "id": 3,
        "titulo": "Amiloidose cardíaca e mieloma múltiplo",
        "especialidade": "Cardiologia",
        ...
        "exames_disponiveis": [
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Hb de 6,7 g/dL, hemácias em Rouleaux.",
                "correto": True,
            },
            {
                "id": "eletroforese",
                "nome": "Eletroforese de proteínas",
                "resultado": "Pico monoclonal.",
                "correto": True,
            },
            {
                "id": "eco",
                "nome": "Ecocardiograma",
                "resultado": "Padrão restritivo, FEVE: 48%.",
                "correto": True,
            },
            {
                "id": "ecg",
                "nome": "ECG",
                "resultado": "Baixa voltagem.",
                "correto": True,
            },
            {
                "id": "biopsia_mo",
                "nome": "Biópsia de Medula Óssea",
                "resultado": "Confirmação diagnóstica.",
                "correto": True,
            },
        ],
    },
    {
        "id": 4,
        "titulo": "Miocardite lúpica e ICFER",
        "especialidade": "Cardiologia",
        "nivel_dificuldade": "Difícil",
        ...
        "exames_disponiveis": [
            {
                "id": "les",
                "nome": "Marcadores de LES (FAN, anti-DNA, anti-Sm)",
                "resultado": "Todos positivos.",
                "correto": True,
            },
            {
                "id": "eco",
                "nome": "Ecocardiograma",
                "resultado": "Derrame pericárdico, FE de 33%.",
                "correto": True,
            },
            {
                "id": "raiox",
                "nome": "Raio-X de tórax",
                "resultado": "Cardiomegalia.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Anemia (Hb 7.9 g/dl).",
                "correto": True,
            },
        ],
    },
    {
        "id": 5,
        "titulo": "Sangramento uterino anormal (Leiomioma)",
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "Padrão ouro para diagnóstico.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Anemia microcítica e hipocrômica.",
                "correto": True,
            },
            {
                "id": "beta_hcg",
    ...
    {
        "id": 6,
        "titulo": "Hematêmese (Úlcera Péptica Perfurada)",
        "especialidade": "Cirurgia",
        "nivel_dificuldade": "Difícil",
        ...
        "exames_disponiveis": [
            ...
            {
                "id": "raiox_abdome",
                "nome": "Raio-X de abdome agudo",
                "resultado": "Presença de pneumoperitônio.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Leucocitose.",
                "correto": True,
            },
        ],
    },
    {
        "id": 7,
        "titulo": "Deficiência de Ferro Pós-Bariátrica",
        ...
        "exames_disponiveis": [
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "HB=4g/dL, VCM=73fL, CHCM=27g/dL.",
                "correto": True,
            },
            {
                "id": "ferro",
                "nome": "Perfil de Ferro",
                "resultado": "Ferro sérico=24mg/dL, ferritina=10g/mL, TIBC=470mg/dL.",
                "correto": True,
            },
            {
                "id": "vit_b12",
                "nome": "Vitamina B12 e Folato",
    ...
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "angiotc",
                "nome": "AngioTC de Tórax",
                "resultado": "Falha de enchimento em artérias pulmonares.",
                "correto": True,
            },
            {
                "id": "dimerod",
                "nome": "D-dímero",
                "resultado": "Maior que 500 ng/dl.",
                "correto": True,
            },
            {
                "id": "doppler_mmss",
                "nome": "USG com Doppler de MMSS",
                "resultado": "Trombose em veia subclávia esquerda.",
                "correto": True,
            },
            {
                "id": "gaso",
    ...
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "clinico",
                "nome": "Diagnóstico Clínico",
                "resultado": "O diagnóstico é primariamente clínico, baseado na tríade de otalgia, vesículas e paralisia facial.",
                "correto": True,
            }
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Anemia moderada, leucocitose com eosinofilia.",
                "correto": True,
            },
            {
                "id": "funcao_hepatica",
                "nome": "Função Hepática",
                "resultado": "Elevação de transaminases.",
                "correto": True,
            },
            {
                "id": "baciloscopia",
                "nome": "Baciloscopia de linfa",
                "resultado": "Pode mostrar bacilos, dependendo da forma.",
                "correto": False,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "prolactina",
                "nome": "Dosagem de Prolactina (PRL)",
                "resultado": "700 ng/ml.",
                "correto": True,
            },
            {
                "id": "rm_sela_turcica",
                "nome": "RM de Sela Túrcica",
                "resultado": "Macroadenoma (2,3x1,8x1,5cm) com compressão do quiasma óptico.",
                "correto": True,
            },
            {
                "id": "tsh_t4l",
    ...
    {
        "id": 12,
        "titulo": "Síndrome de Cushing Iatrogênica",
        "especialidade": "Endocrinologia",
        "nivel_dificuldade": "Intermediário",
        ...
        "exames_disponiveis": [
            {
                "id": "cortisol_acth",
                "nome": "Cortisol e ACTH plasmático",
                "resultado": "Cortisol indosável e ACTH suprimido.",
                "correto": True,
            },
            {
                "id": "glicemia",
    ...
    {
        "id": 13,
        "titulo": "Colangite Esclerosante Primária",
        ...
        "exames_disponiveis": [
            {
                "id": "cpre",
                "nome": "Colangiopancreatografia Retrógrada Endoscópica (CPRE)",
                "resultado": "Múltiplas estenoses e dilatações dos ductos biliares (padrão 'contas de rosário').",
                "correto": True,
            },
            {
                "id": "funcao_hepatica",
                "nome": "Função Hepática",
                "resultado": "Padrão colestático com elevação de Fosfatase Alcalina e GGT.",
                "correto": True,
            },
            {
                "id": "anticorpos",
                "nome": "Anticorpos (p-ANCA)",
                "resultado": "Positivo.",
                "correto": True,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "amilase_lipase",
                "nome": "Amilase e Lipase séricas",
                "resultado": "Amilase: 300 U/L, Lipase: 190 I/L (ambas elevadas > 3x o LSN).",
                "correto": True,
            },
            {
                "id": "usg_abdome",
                "nome": "USG de Abdome",
                "resultado": "Pâncreas edemaciado, presença de cálculos na vesícula biliar.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Leucocitose (20.000).",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "Confirma espessamento da zona juncional, confirmando adenomiose.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Anemia ferropriva (Hb: 8,7 g/dL).",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "cariotipo",
                "nome": "Cariótipo",
                "resultado": "45,X, confirmando o diagnóstico.",
                "correto": True,
            },
            {
                "id": "hormonios",
                "nome": "Dosagens Hormonais (FSH, LH)",
                "resultado": "FSH: 67mUI/ml, LH: 29 mUI/ml (elevados por falência ovariana).",
                "correto": True,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "usg_tv_preparo",
                "nome": "USG Transvaginal com Preparo Intestinal",
                "resultado": "Detecta focos de endometriose profunda.",
                "correto": True,
            },
            {
                "id": "ca125",
                "nome": "CA-125",
                "resultado": "Pode estar elevado, mas é inespecífico.",
                "correto": False,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "raspado",
                "nome": "Raspado do fundo da lesão (Citologia)",
                "resultado": "Presença de células gigantes multinucleadas.",
                "correto": True,
            },
            {
                "id": "sorologia",
                "nome": "Sorologia para Herpes (HSV)",
                "resultado": "IgG reagente, IgM não reagente.",
                "correto": True,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "gram",
                "nome": "Bacterioscopia (Gram) da secreção",
                "resultado": "Presença de diplococos Gram-negativos intracelulares.",
                "correto": True,
            },
            {
                "id": "pcr_clamidia",
                "nome": "PCR para Clamídia",
                "resultado": "Recomendado para co-infecção.",
                "correto": True,
            },
        ],
    },
    {
        "id": 20,
        "titulo": "Síndrome do Encarceramento (Locked-in)",
        ...
        "exames_disponiveis": [
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Área de infarto em ponte ventral.",
                "correto": True,
            },
            {
                "id": "puncao_lombar",
                "nome": "Punção Lombar",
                "resultado": "Líquor hemorrágico.",
                "correto": True,
            },
            {
                "id": "angiografia",
                "nome": "Angiografia Cerebral",
                "resultado": "Trombose da artéria basilar.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "Avalia a gravidade da lesão do nervo facial.",
                "correto": True,
            },
            {
                "id": "rm_cranio",
                "nome": "RM de Crânio",
                "resultado": "Exclui outras causas como tumores.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "clinico",
                "nome": "Diagnóstico Clínico",
                "resultado": "Baseado nos critérios do ICHD-3.",
                "correto": True,
            }
        ],
    },
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "Padrão de hipsarritmia.",
                "correto": True,
            },
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Pode mostrar a etiologia (ex: esclerose tuberosa).",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "clinico",
                "nome": "Diagnóstico Clínico",
                "resultado": "Baseado nos critérios, incluindo o déficit neurológico focal (afasia).",
                "correto": True,
            },
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Solicitada para excluir outras causas, resultado normal.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "eeg",
                "nome": "Eletroencefalograma (EEG)",
                "resultado": "Atividade contínua de ondas e picos.",
                "correto": True,
            },
            {
                "id": "glicemia_capilar",
                "nome": "Glicemia Capilar",
                "resultado": "Essencial para descartar hipoglicemia como causa.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Obstrução arterial em território de cerebral posterior.",
                "correto": True,
            },
            {
                "id": "angio_tc",
                "nome": "AngioTC de Crânio",
                "resultado": "Confirma a localização da oclusão.",
                "correto": True,
            },
        ],
    },
    {
        "id": 27,
        "titulo": "Avaliação Nutricional (Doença de Chagas)",
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "Avalia o estado nutricional proteico.",
                "correto": True,
            },
            {
                "id": "endoscopia",
                "nome": "Endoscopia Digestiva Alta",
                "resultado": "Avalia megaesôfago chagásico.",
                "correto": True,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "anti_ttg",
                "nome": "Anticorpo Anti-Transglutaminase IgA",
                "resultado": "Elevado, altamente sugestivo de Doença Celíaca.",
                "correto": True,
            },
            {
                "id": "biopsia_duodeno",
                "nome": "Biópsia de Duodeno via Endoscopia",
                "resultado": "Atrofia das vilosidades, confirma o diagnóstico.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Anemia (Hemoglobina=11,2g/dL).",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                ...
                "nome": "Teste Rápido para Streptococcus A",
                "resultado": "Positivo.",
                "correto": True,
            },
            {
                ...
                "resultado": "Confirma Streptococcus pyogenes.",
                "correto": True,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "aslo",
                "nome": "Antiestreptolisina O (ASLO)",
                "resultado": "Título elevado, indica infecção estreptocócica recente.",
                "correto": True,
            },
            {
                "id": "eco",
                "nome": "Ecocardiograma",
                "resultado": "Confirma as valvulopatias (insuficiência e estenose).",
                "correto": True,
            },
            {
                "id": "vhs_pcr",
                "nome": "VHS e PCR",
                "resultado": "Elevados, indicando atividade inflamatória.",
                "correto": True,
            },
        ],
    },
    {
        "id": 31,
        "titulo": "Síndrome do Bebê Sacudido",
        ...
        "exames_disponiveis": [
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Hemorragia inter-hemisférica e edema cerebral.",
                "correto": True,
            },
            {
                "id": "fundo_olho",
                "nome": "Fundoscopia",
                "resultado": "Hemorragia retiniana bilateral difusa.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "mchat",
                "nome": "Escala M-CHAT",
                "resultado": "Triagem para autismo, pontuação de risco.",
                "correto": True,
            },
            {
                "id": "avaliacao_neuro",
                "nome": "Avaliação com Neuropediatra",
                "resultado": "Diagnóstico clínico baseado em observação e critérios do DSM-5.",
                "correto": True,
            },
        ],
    },
    {
        ...
        "exames_disponiveis": [
            {
                "id": "dea",
                "nome": "Análise de Ritmo (DEA/Monitor)",
                "resultado": "Fibrilação ventricular.",
                "correto": True,
            }
        ],
    },
    {
        "id": 34,
        "titulo": "AIT por Cardioembolismo Paradoxal",
        "especialidade": "Urgência e Emergência",
        "nivel_dificuldade": "Difícil",
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "Detecta Forame Oval Patente (FOP) e mixoma em átrio direito.",
                "correto": True,
            },
            {
                "id": "rm_cranio",
                "nome": "RM de Crânio",
                "resultado": "Pode mostrar pequenas áreas de isquemia não visíveis na TC.",
                "correto": True,
            },
        ],
    },
    {
        "id": 35,
        "titulo": "Trauma Cranioencefálico em Lactente",
        "especialidade": "Urgência e Emergência",
        "nivel_dificuldade": "Difícil",
        ...
        "exames_disponiveis": [
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Hemorragia inter-hemisférica.",
                "correto": True,
            },
            {
                "id": "rx_corpo",
                "nome": "Raio-X de esqueleto",
                "resultado": "Pode revelar fraturas em diferentes estágios de consolidação.",
                "correto": True,
            },
        ],
    },
    {
        "id": 36,
        "titulo": "Sepse de Foco Gastrointestinal",
        "especialidade": "Urgência e Emergência",
        "nivel_dificuldade": "Crítico",
        ...
        "exames_disponiveis": [
            {
                "id": "lactato",
                "nome": "Lactato sérico",
                "resultado": "2,1 (elevado), indicando má perfusão.",
                "correto": True,
            },
            {
                "id": "hemoculturas",
                "nome": "Hemoculturas",
                "resultado": "Coletar 2 pares antes de iniciar antibiótico.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Leucocitose (20.000) com desvio (Bast 4%).",
                "correto": True,
            },
        ],
    },
    {
        "id": 37,
        "titulo": "Encefalopatia Hipertensiva",
        "especialidade": "Urgência e Emergência",
        "nivel_dificuldade": "Crítico",
        ...
        "exames_disponiveis": [
            {
                "id": "fundo_olho",
                "nome": "Fundoscopia",
                "resultado": "Presença de papiledema e hemorragias retinianas.",
                "correto": True,
            },
            {
                "id": "tc_cranio",
                "nome": "TC de Crânio",
                "resultado": "Descarta AVE hemorrágico.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "raiox_torax",
                "nome": "Raio-X de Tórax",
                "resultado": "Infiltrado alveloar bilateral em 'asa de borboleta', cardiomegalia.",
                "correto": True,
            },
            {
                "id": "bnp",
                "nome": "BNP ou pro-BNP",
                "resultado": "Elevado, sugere causa cardíaca.",
                "correto": True,
            },
            {
                "id": "ecg",
                "nome": "ECG",
                "resultado": "Pode mostrar isquemia ou sobrecarga ventricular.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                ...
                "resultado": "6,0 ng/dl (elevado).",
                "correto": True,
            },
            {
                "id": "usg_vias_urinarias",
                "nome": "USG de Vias Urinárias",
                "resultado": "Próstata de 70 g, bexiga espessada, uretéro-hidronefrose bilateral.",
                "correto": True,
            },
            {
                "id": "urina1",
                "nome": "Sumário de Urina",
                "resultado": "Descarta infecção urinária.",
                "correto": True,
            },
        ],
    },
        ...
        "exames_disponiveis": [
            {
                "id": "urina1",
                "nome": "Sumário de Urina",
                "resultado": "Urina turva, proteinúria, leucocitúria, nitrito positivo, cilindros leucocitários.",
                "correto": True,
            },
            {
                "id": "urocultura",
                "nome": "Urocultura com Antibiograma",
                "resultado": "Identifica o agente e a sensibilidade a antibióticos.",
                "correto": True,
            },
            {
                "id": "hemo",
                "nome": "Hemograma",
                "resultado": "Leucocitose com desvio à esquerda.",
                "correto": True,
            },
        ],
    },
...
def get_clinical_case(case_id: int) -> dict | None:
    return next((case for case in CLINICAL_CASES if case["id"] == case_id), None)


def clinical_case_exists(case_id: int) -> bool:
    return get_clinical_case(case_id) is not None
