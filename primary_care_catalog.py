...
PRIMARY_CARE_RUBRICS = {
    41: _rubric(
        ...
        conduct=[
            _criterion("Cuidado sintomático", 12, "analgesico", "antitermico", "hidratacao", "repouso"),
            _criterion("Evitar antibiótico", 10, "sem antibiotico", "nao prescrever antibiotico", "viral"),
            _criterion("Orientar retorno", 8, "retorno", "piora", "falta de ar", "dificuldade para engolir"),
        ],
        ...
        learning_goals=["Reconhecer sinais de etiologia viral", "Evitar exames e antibióticos de baixo valor", "Explicar sinais de retorno"],
        safety_criteria=[_safety("Reconhecimento de sinais de alarme", "Sem orientação de retorno, uma complicação respiratória ou infecciosa pode ser reconhecida tardiamente.", "falta de ar", "dificuldade para engolir", "retorno", "piora")],
        outcomes=_outcomes("A dor e o desconforto começam a ceder com suporte sintomático.", "A evolução tende a ser autolimitada, com retorno se houver piora.", "Há alívio parcial, mas as orientações ficam incompletas.", "O paciente pode procurar novamente a unidade por dúvidas ou persistência.", "Antibiótico desnecessário expõe a efeitos adversos sem acelerar a melhora.", "A conduta aumenta dano evitável e resistência antimicrobiana."),
        ...
        study_topics=["Faringite viral", "Uso racional de antibióticos", "Sinais de alarme respiratórios"],
        sources=[APS_SOURCE],
    ),
    42: _rubric(
        ...
        conduct=[
            _criterion("Controle da dor", 10, "analgesico", "analgesia", "paracetamol", "ibuprofeno"),
            _criterion("Estratégia antimicrobiana adequada", 12, "observacao", "antibiotico", "amoxicilina", "reavaliacao"),
            _criterion("Orientação à família", 8, "retorno", "mastoid", "piora", "48 horas", "72 horas"),
        ],
        ...
        learning_goals=["Interpretar a otoscopia", "Priorizar analgesia", "Escolher observação ou antibiótico com segurança"],
        safety_criteria=[_safety("Vigilância de mastoidite", "A família deve saber reconhecer edema ou dor atrás da orelha e piora sistêmica.", "mastoid", "edema atras", "piora", "retorno")],
        outcomes=_outcomes("A criança fica mais confortável após analgesia e aceita melhor líquidos.", "Com observação segura ou tratamento indicado, a infecção tende a resolver sem complicações.", "A dor melhora, mas faltam critérios claros de reavaliação.", "Persistência dos sintomas pode atrasar ajuste do tratamento.", "Omissão de analgesia ou de sinais de complicação mantém sofrimento e atrasa atendimento.", "Uma mastoidite poderia evoluir sem reconhecimento oportuno."),
        ...
        study_topics=["Otoscopia na OMA", "Analgesia pediátrica", "Critérios de observação e antibiótico"],
        sources=[APS_SOURCE],
    ),
    43: _rubric(
        ...
        conduct=[
            _criterion("Tratamento sintomático", 12, "lavagem nasal", "soro fisiologico", "analgesico", "hidratacao"),
            _criterion("Evitar antibiótico precoce", 10, "sem antibiotico", "viral", "nao prescrever"),
            _criterion("Reavaliar evolução", 8, "10 dias", "dupla piora", "febre alta", "edema orbitario", "retorno"),
        ],
        ...
        learning_goals=["Diferenciar padrão viral e bacteriano", "Evitar imagem sem indicação", "Reconhecer complicações orbitárias"],
        safety_criteria=[_safety("Sinais orbitários ou neurológicos", "Complicações são raras, mas precisam de avaliação urgente quando presentes.", "edema orbitario", "alteracao visual", "cefaleia intensa", "neurologico")],
        outcomes=_outcomes("A obstrução e a pressão facial diminuem gradualmente com medidas locais.", "O quadro tende a resolver sem antibiótico.", "Há algum alívio, mas o paciente não sabe quando retornar.", "Persistência ou piora pode gerar nova consulta sem orientação clara.", "Exames e antibiótico desnecessários acrescentam efeitos adversos e custo.", "Uma complicação real pode ser mascarada se a reavaliação não for explicada."),
        ...
        study_topics=["Rinossinusite aguda", "Critérios de provável etiologia bacteriana", "Uso racional de imagem"],
        sources=[APS_SOURCE],
    ),
    44: _rubric(
        ...
        conduct=[
            _criterion("Broncodilatador inalatório", 12, "salbutamol", "broncodilatador", "inalatorio", "espacador"),
            _criterion("Reavaliar gravidade", 10, "reavaliar", "saturacao", "pico de fluxo", "frequencia respiratoria"),
            _criterion("Plano e prevenção", 8, "plano de acao", "tecnica inalatoria", "controlador", "gatilho", "retorno"),
        ],
        ...
        learning_goals=["Classificar gravidade da crise", "Usar broncodilatador com espaçador", "Reavaliar resposta e prevenção"],
        safety_criteria=[_safety("Reavaliação respiratória", "Sem reavaliação, uma resposta insuficiente ao broncodilatador pode passar despercebida.", "reavaliar", "saturacao", "pico de fluxo", "fala")],
        outcomes=_outcomes("O chiado e o aperto diminuem após broncodilatador inalatório.", "Com plano de ação e controle do gatilho, o paciente pode seguir em acompanhamento ambulatorial.", "A melhora é parcial, mas fatores de recorrência permanecem sem abordagem.", "Há maior chance de nova crise e retorno não planejado.", "Sem broncodilatador ou reavaliação, a obstrução pode progredir.", "O paciente pode evoluir para crise moderada ou grave e precisar de urgência."),
        ...
        study_topics=["Exacerbação de asma", "Técnica inalatória", "Plano de ação para asma"],
        sources=[LINES_SOURCE],
    ),
    45: _rubric(
        diagnosis="Cistite aguda não complicada.",
        terms=["cistite aguda", "infeccao urinaria baixa", "itu baixa", "cistite nao complicada"],
        ...
        conduct=[
            _criterion("Antimicrobiano apropriado", 12, "antibiotico", "nitrofurantoina", "fosfomicina"),
            _criterion("Alívio e orientação", 8, "hidratacao", "analgesia", "orientar"),
            _criterion("Excluir complicação", 10, "febre", "dor lombar", "pielonefrite", "gestacao", "retorno"),
        ],
        ...
        learning_goals=["Reconhecer cistite típica", "Indicar urocultura seletivamente", "Diferenciar pielonefrite"],
        safety_criteria=[_safety("Excluir pielonefrite e gestação", "Esses fatores alteram o risco, a investigação e o tratamento.", "febre", "dor lombar", "pielonefrite", "gestacao")],
        outcomes=_outcomes("A disúria e a urgência tendem a melhorar após o início do tratamento adequado.", "A infecção resolve com seguimento ambulatorial e retorno se necessário.", "Há melhora incompleta ou demora por escolha terapêutica pouco clara.", "Persistência requer reavaliação e possível cultura.", "Ignorar sinais de infecção alta ou tratar de forma inadequada permite progressão.", "Pode ocorrer pielonefrite e necessidade de atendimento urgente."),
        ...
        study_topics=["Cistite não complicada", "Indicações de urocultura", "Sinais de pielonefrite"],
        sources=[WOMEN_SOURCE],
    ),
    46: _rubric(
        diagnosis="Candidíase vulvovaginal não complicada.",
        terms=["candidiase vulvovaginal", "vulvovaginite por candida", "candidiase vaginal"],
        ...
        conduct=[
            _criterion("Antifúngico adequado", 12, "antifungico", "fluconazol", "azol", "miconazol", "clotrimazol"),
            _criterion("Avaliar fatores especiais", 10, "gestacao", "diabetes", "recorrente", "imunossupressao"),
            _criterion("Orientar reavaliação", 8, "retorno", "persistencia", "dor pelvica", "febre"),
        ],
        ...
        learning_goals=["Diferenciar causas comuns de corrimento", "Reconhecer candidíase complicada", "Evitar investigação de baixo valor"],
        safety_criteria=[_safety("Avaliação de gestação e complicação", "A escolha do tratamento e a investigação mudam nesses cenários.", "gestacao", "diabetes", "recorrente", "imunossupressao")],
        outcomes=_outcomes("O prurido e o desconforto começam a diminuir após o antifúngico.", "O quadro tende a resolver; persistência exige confirmação diagnóstica.", "Há alívio parcial, mas fatores de recorrência ficam sem avaliação.", "Sintomas podem retornar e exigir nova consulta.", "Tratamento inadequado pode irritar a mucosa ou mascarar outro diagnóstico.", "Uma IST ou doença pélvica poderia ter reconhecimento tardio se surgirem sinais atípicos."),
        ...
        study_topics=["Corrimento vaginal", "Candidíase vulvovaginal", "Vaginites diferenciais"],
        sources=[WOMEN_SOURCE],
    ),
    47: _rubric(
        ...
        conduct=[
            _criterion("Hidratação e sintomáticos seguros", 12, "hidratacao oral", "soro de reidratacao", "paracetamol", "dipirona"),
            _criterion("Evitar medicamentos de risco", 8, "evitar aines", "sem aines", "ibuprofeno", "aas", "aspirina"),
            _criterion("Orientar sinais de alarme", 10, "dor abdominal", "vomitos persistentes", "sangramento", "tontura", "retorno"),
        ],
        ...
        learning_goals=["Classificar dengue por risco", "Orientar hidratação", "Reconhecer sinais de alarme e medicamentos contraindicados"],
        safety_criteria=[
            _safety("Orientação de sinais de alarme", "Sem essa orientação, a fase crítica pode começar fora da unidade sem reconhecimento oportuno.", "dor abdominal", "vomitos persistentes", "sangramento", "tontura", "retorno"),
            _safety("Evitar AAS e anti-inflamatórios", "Esses medicamentos podem aumentar o risco de sangramento.", "evitar aines", "sem aines", "aas", "aspirina", "ibuprofeno"),
        ],
        outcomes=_outcomes("O paciente mantém boa perfusão e tolera o plano de hidratação oral.", "Segue em acompanhamento, sabendo quando retornar durante a possível fase crítica.", "A hidratação ajuda, mas a orientação de segurança fica incompleta.", "Uma piora pode ser percebida mais tarde do que o ideal.", "Anti-inflamatórios ou ausência de retorno programado aumentam o risco evitável.", "Sinais de alarme podem progredir para dengue grave sem avaliação rápida."),
        ...
        study_topics=["Classificação de risco da dengue", "Hidratação oral", "Fase crítica e sinais de alarme"],
        sources=[DENGUE_SOURCE],
    ),
    48: _rubric(
        diagnosis="Gastroenterite aguda sem sinais de desidratação.",
        terms=["gastroenterite aguda", "diarreia aguda infecciosa", "gastroenterite sem desidratacao"],
        ...
        conduct=[
            _criterion("Reidratação oral", 12, "soro de reidratacao", "hidratacao oral", "liquidos"),
            _criterion("Alimentação e suporte", 8, "manter alimentacao", "dieta", "antiemetico", "higiene"),
            _criterion("Sinais de retorno", 10, "sangue nas fezes", "desidratacao", "febre alta", "dor intensa", "retorno"),
        ],
        ...
        learning_goals=["Avaliar hidratação", "Indicar reidratação oral", "Evitar exames e antibióticos rotineiros"],
        safety_criteria=[_safety("Vigilância de desidratação", "A perda persistente de líquidos pode levar a deterioração rápida se não houver retorno.", "desidratacao", "pouca urina", "incapacidade de hidratar", "retorno")],
        outcomes=_outcomes("A sede e o mal-estar diminuem com reidratação oral fracionada.", "O episódio tende a resolver com suporte e alimentação tolerada.", "A hidratação é insuficiente ou as orientações ficam vagas.", "Persistência das perdas pode exigir reavaliação.", "Antibiótico ou antidiarreico inadequado pode causar efeitos adversos e atrasar reconhecimento de gravidade.", "O paciente pode evoluir com desidratação e alteração renal/eletrolítica."),
        ...
        study_topics=["Avaliação da desidratação", "Terapia de reidratação oral", "Indicações de coprocultura"],
        sources=[APS_SOURCE],
    ),
    49: _rubric(
        ...
        conduct=[
            _criterion("Mudanças comportamentais", 10, "perder peso", "refeicoes menores", "evitar deitar", "elevar cabeceira", "gatilhos"),
            _criterion("Teste terapêutico", 12, "inibidor de bomba", "ibp", "omeprazol", "tratamento empirico"),
            _criterion("Reavaliar alarmes", 8, "disfagia", "perda de peso", "sangramento", "anemia", "retorno"),
        ],
        ...
        learning_goals=["Reconhecer refluxo típico", "Identificar sinais de alarme", "Evitar endoscopia precoce sem indicação"],
        safety_criteria=[_safety("Triagem de sinais de alarme", "Sinais de alarme mudam a necessidade e a urgência da investigação.", "disfagia", "perda de peso", "sangramento", "anemia", "vomitos")],
        outcomes=_outcomes("A queimação diminui com ajustes de hábitos e tratamento inicial.", "O paciente segue em teste terapêutico com reavaliação programada.", "Há melhora parcial, mas gatilhos ou seguimento não foram abordados.", "Sintomas podem persistir e exigir nova avaliação.", "Investigar demais ou ignorar alarmes cria, respectivamente, dano de baixo valor ou atraso diagnóstico.", "Uma causa estrutural pode permanecer sem diagnóstico se sinais de alarme surgirem e forem ignorados."),
        ...
        study_topics=["DRGE", "Sinais de alarme digestivos", "Tratamento empírico e reavaliação"],
        sources=[APS_SOURCE],
    ),
    50: _rubric(
        diagnosis="Escabiose familiar.",
        terms=["escabiose", "sarna", "infestacao por sarcoptes"],
        partial_terms=["dermatose contagiosa", "prurido familiar", "parasitose cutanea"],
        essential_exams=[],
        ...
        conduct=[
            _criterion("Tratamento escabicida", 10, "permetrina", "ivermectina", "escabicida"),
            _criterion("Tratar contatos simultaneamente", 12, "contatos", "familia", "todos da casa", "simultaneo"),
            _criterion("Ambiente e retorno", 8, "roupas", "roupa de cama", "lavar", "persistencia", "retorno"),
        ],
        ...
        learning_goals=["Reconhecer distribuição típica", "Tratar contatos", "Orientar controle ambiental sem excessos"],
        safety_criteria=[_safety("Tratamento simultâneo dos contatos", "Sem tratar os contatos, a reinfestação familiar é muito provável.", "contatos", "familia", "todos da casa", "simultaneo")],
        outcomes=_outcomes("O surgimento de novas lesões diminui após tratamento correto de toda a família.", "A cadeia de transmissão é interrompida, embora o prurido residual possa durar algum tempo.", "O paciente melhora, mas um contato não tratado mantém a transmissão.", "Há recorrência e necessidade de repetir o manejo.", "Corticoide isolado ou tratamento apenas do paciente mascara sintomas sem eliminar o ácaro.", "A infestação se mantém e pode ocorrer infecção bacteriana por escoriação."),
    ...
    51: _rubric(
        ...
        conduct=[
            _criterion("Antifúngico tópico", 12, "antifungico topico", "terbinafina", "azol", "clotrimazol"),
            _criterion("Evitar corticoide isolado", 10, "sem corticoide", "evitar corticoide", "tinea incognito"),
            _criterion("Fonte e reavaliação", 8, "animal", "gato", "higiene", "retorno", "persistencia"),
        ],
        ...
        learning_goals=["Reconhecer lesão anular por dermatófito", "Evitar corticoide isolado", "Definir quando confirmar com exame micológico"],
        safety_criteria=[_safety("Evitar corticoide isolado", "O corticoide pode mascarar a borda e favorecer progressão da dermatofitose.", "sem corticoide", "evitar corticoide", "tinea incognito")],
        outcomes=_outcomes("O prurido e a borda ativa diminuem com o antifúngico.", "A lesão regride gradualmente, com reavaliação se não houver resposta.", "O tratamento é iniciado, mas a fonte ou o seguimento ficam sem abordagem.", "Pode ocorrer recorrência após novo contato.", "Corticoide isolado reduz temporariamente a vermelhidão e facilita expansão do fungo.", "A apresentação fica mascarada e mais extensa, dificultando o diagnóstico."),
    ...
    52: _rubric(
        ...
        terms=["lombalgia mecanica aguda", "dor lombar mecanica", "lombalgia aguda inespecifica"],
        ...
        conduct=[
            _criterion("Manter atividade", 10, "manter atividade", "evitar repouso", "retorno gradual", "movimentar"),
            _criterion("Analgesia e medidas locais", 10, "analgesico", "calor local", "fisioterapia", "orientacao postural"),
            _criterion("Sinais de alarme", 10, "anestesia em sela", "retencao urinaria", "fraqueza", "febre", "retorno"),
        ],
        ...
        learning_goals=["Triar sinais de alarme", "Evitar imagem precoce", "Promover recuperação ativa"],
        safety_criteria=[_safety("Síndrome da cauda equina e déficit", "Alterações esfincterianas, anestesia em sela ou fraqueza exigem avaliação urgente.", "anestesia em sela", "retencao urinaria", "fraqueza", "cauda equina")],
        outcomes=_outcomes("A dor fica mais controlável e o paciente mantém mobilidade segura.", "A recuperação funcional ocorre gradualmente, sem exames desnecessários.", "Há alívio parcial, mas medo do movimento ou seguimento inadequado prolonga limitação.", "O retorno às atividades pode atrasar.", "Repouso prolongado, opioide sem critério ou omissão de sinais neurológicos aumenta dano.", "Pode haver cronificação ou atraso no reconhecimento de compressão neurológica."),
        ...
        study_topics=["Lombalgia inespecífica", "Red flags", "Uso racional de exames de imagem"],
        sources=[LINES_SOURCE],
    ),
    53: _rubric(
        ...
        conduct=[
            _criterion("Confirmar e estratificar", 10, "mrpa", "mapa", "confirmar", "risco cardiovascular", "orgao alvo"),
            _criterion("Tratamento longitudinal", 12, "anti hipertensivo", "antihipertensivo", "mudanca de estilo", "reduzir sal", "atividade fisica"),
            _criterion("Evitar redução abrupta", 8, "sem urgencia", "nao reduzir abruptamente", "acompanhamento", "retorno"),
        ],
        ...
        learning_goals=["Confirmar hipertensão corretamente", "Estratificar risco cardiovascular", "Diferenciar hipertensão grave de emergência"],
        safety_criteria=[_safety("Excluir emergência hipertensiva", "Elevação pressórica com lesão aguda de órgão-alvo exige atendimento imediato.", "dor toracica", "deficit neurologico", "dispneia", "orgao alvo", "emergencia")],
        outcomes=_outcomes("O paciente compreende que a pressão será controlada com plano progressivo e acompanhamento.", "O risco cardiovascular começa a ser reduzido com adesão e metas individualizadas.", "Há orientação inicial, mas confirmação ou estratificação ficam incompletas.", "O controle pode atrasar ou o tratamento pode ser mal ajustado.", "Redução abrupta sem indicação pode causar hipotensão e hipoperfusão.", "O paciente sofre dano iatrogênico ou permanece sem avaliação de risco adequada."),
    ...
    54: _rubric(
        ...
        terms=["diabetes mellitus tipo 2 descompensado", "dm2 fora da meta", "diabetes tipo 2 fora da meta"],
        ...
        conduct=[
            _criterion("Revisar adesão e barreiras", 8, "adesao", "barreira", "uso irregular", "educacao"),
            _criterion("Ajustar plano terapêutico", 12, "ajustar tratamento", "metformina", "antidiabetico", "meta individual", "alimentacao", "atividade fisica"),
            _criterion("Prevenir complicações", 10, "pes", "retina", "albuminuria", "risco cardiovascular", "retorno"),
        ],
        ...
        learning_goals=["Interpretar HbA1c", "Avaliar rim, pés e risco cardiovascular", "Distinguir descontrole crônico de emergência"],
        safety_criteria=[_safety("Triagem de crise hiperglicêmica", "Sinais de cetoacidose ou estado hiperosmolar exigem atendimento urgente.", "vomitos", "dor abdominal", "respiracao profunda", "alteracao de consciencia", "desidratacao")],
        outcomes=_outcomes("A paciente entende as metas e participa de um plano viável para retomar o tratamento.", "O controle melhora progressivamente e as complicações passam a ser monitoradas.", "O medicamento é ajustado, mas barreiras ou prevenção ficam incompletas.", "A adesão pode continuar baixa e a HbA1c permanecer elevada.", "Ignorar sinais de crise ou função renal pode tornar o tratamento inseguro.", "Há risco de evento adverso, progressão de complicações ou emergência hiperglicêmica não reconhecida."),
        ...
        study_topics=["Metas de HbA1c", "Doença renal diabética", "Prevenção cardiovascular no DM2"],
        sources=[LINES_SOURCE],
    ),
    55: _rubric(
        ...
        conduct=[
            _criterion("Suporte sintomático", 10, "compressa fria", "lubrificante", "lagrima artificial", "higiene"),
            _criterion("Reduzir transmissão", 10, "lavar as maos", "nao compartilhar", "toalha", "contagioso"),
            _criterion("Reconhecer urgência ocular", 10, "dor intensa", "fotofobia", "baixa visual", "lente de contato", "retorno"),
        ],
        ...
        learning_goals=["Diferenciar causas comuns de olho vermelho", "Orientar prevenção de transmissão", "Reconhecer sinais de doença corneana"],
        safety_criteria=[_safety("Sinais de ameaça à visão", "Dor, fotofobia ou perda visual não combinam com conjuntivite simples e exigem avaliação rápida.", "dor intensa", "fotofobia", "baixa visual", "opacidade corneana", "lente de contato")],
        outcomes=_outcomes("O desconforto diminui com compressas e lubrificação, mantendo a visão preservada.", "O quadro tende a resolver e a transmissão é reduzida pelas medidas de higiene.", "Há suporte, mas faltam medidas de prevenção ou sinais de retorno.", "Outras pessoas podem ser expostas ou uma piora pode ser percebida tarde.", "Antibiótico desnecessário ou omissão de sinais corneanos aumenta risco sem benefício.", "Uma ceratite ou outra causa grave de olho vermelho pode ter avaliação atrasada."),
        ...
        study_topics=["Diagnóstico diferencial de olho vermelho", "Conjuntivite viral", "Sinais de urgência oftalmológica"],
        sources=[APS_SOURCE],
    ),
}
