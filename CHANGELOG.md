...
- Repertório compartilhado de IA para Codex e Google Antigravity, com Graphify
  0.9.53 preservado, versão e checksums fixados e configuração local
  reproduzível.
- Regras e workflow do Antigravity para consultar o grafo antes de mudanças
  arquiteturais em Synapse, avaliação, autenticação, pagamentos e contratos.
- Grafo arquitetural da API gerado localmente a partir do código, sem LLM ou
  envio de documentos.
